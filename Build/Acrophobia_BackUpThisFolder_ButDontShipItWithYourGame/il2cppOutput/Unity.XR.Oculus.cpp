...
IL_00d8:
	{
		...
		UserDefinedSettings_tA825721C19A55520B2D67138B3D58565E0135D3D  L_23 = V_4;
...
IL_00e7:
	...
	}
	{
		...
		G_B31_0 = ((((RuntimeObject*)(XRInputSubsystem_t74B79E3971C396F02CD32F74AE73A5DFB2A0EC09 *)L_27) == ((RuntimeObject*)(RuntimeObject *)NULL))? 1 : 0);
		goto IL_011d;
	}
...
IL_0132:
	{
		...
		XRDisplaySubsystem_tF8B46605B6D1199C52306D4EC7D83CFA90564A93 * L_29;
		L_29 = OculusLoader_get_displaySubsystem_mE2C42E00522835401105B4A163E0768AA433E71A(__this, /*hidden argument*/NULL);
		V_6 = (bool)((((RuntimeObject*)(XRDisplaySubsystem_tF8B46605B6D1199C52306D4EC7D83CFA90564A93 *)L_29) == ((RuntimeObject*)(RuntimeObject *)NULL))? 1 : 0);
		bool L_30 = V_6;
		if (!L_30)
		{
			goto IL_0150;
...
IL_0150:
	{
		...
		V_7 = (bool)((((RuntimeObject*)(XRInputSubsystem_t74B79E3971C396F02CD32F74AE73A5DFB2A0EC09 *)L_31) == ((RuntimeObject*)(RuntimeObject *)NULL))? 1 : 0);
		bool L_32 = V_7;
		if (!L_32)
		{
			goto IL_016e;
...
IL_0176:
	...
	}
	{
		...
		G_B41_0 = ((!(((RuntimeObject*)(XRInputSubsystem_t74B79E3971C396F02CD32F74AE73A5DFB2A0EC09 *)L_34) <= ((RuntimeObject*)(RuntimeObject *)NULL)))? 1 : 0);
		goto IL_018a;
	}
...
IL_000f:
	{
		...
		UnityAction__ctor_m48C04C4C0F46918CF216A2410A4E58D31B6362BA(L_2, NULL, (intptr_t)((intptr_t)ShutdownMonitor_Update_m1AAEE5F036F747C379E2B5917E017A64A6998A9E_RuntimeMethod_var), /*hidden argument*/NULL);
		Application_add_onBeforeRender_mFA00908B51F922621B710B65E8576C29D437FE19(L_2, /*hidden argument*/NULL);
	}
